    ...
    <div className='share'>
      <div className="shareWrapper">
        <div className="shareTop">
            ...
            <textarea type="text" rows={2} style={{resize: "none", overflow: "hidden"}} placeholder={ "What's on your mind " + currentUser.displayName + "?"} value={input} className='shareInput' onChange={(e) => setInput(e.target.value)} onKeyDown={handleKey} />
        </div>
        ...
        <div className="shareBottom">
            <div className="shareOptions">
                ...
                <label htmlFor='file' className="shareOption">
                    ...
                    <input type="file" id="file" accept='.png,.jpeg,.jpg' style={{ display: "none" }} onChange={(e) => setImg(e.target.files[0])} />
                </label>

...
import { addDoc, collection, deleteDoc, onSnapshot, doc, setDoc, serverTimestamp } from "firebase/firestore";
...
const Post = ({ post }) => {
  ...
  useEffect(() => {
    const unSub = onSnapshot(collection(db, "posts", post.id, "comments"), (snapshot) => {
  ...
  return (
    <div className='post'>
        <div className="postWrapper">
            <div className="postTop">
                <div className="postTopLeft">
                    ...
                    <span className="postDate"><TimeAgo date={new Date(post.data?.timestamp?.toDate()).toLocaleString()} /></span>
                </div>
            ...
            <div className="postBottom">
                <div className="postBottomLeft">
                    ...
                    <ThumbUp onClick={(e)=>{likePost();}} className='bottomLeftIcon' style={{ color: "#011631" }} />
                    {likes.length > 0 && (
            ...
            <div className="postBottomFooter">
                ...
                {liked? (<ThumbUp style={{color: "#011631"}} className="footerIcon" />): (<ThumbUpAltOutlined className='footerIcon' />)}
        ...
        { commentBoxVisible && (
          ...
          <textarea type="text" placeholder="Write a comment ..." className="commentInput" rows={1} style={{resize: "none"}} value={input} onChange={(e) => setInput(e.target.value)} />
